...
module.exports = class extends Generator {
	constructor(args, opts, scaffolderName, cloudFoundryName, customServiceKey, customCredKeys) {
		...
		this.logger = log4js.getLogger("generator-ibm-cloud-assets:" + scaffolderName);
	...
	_addMappings(config) {
		...
		let mapping = fs.readFileSync(path.join(__dirname, '../service', 'templates', `mappings.v${version}.json.template`), 'utf-8');
